...
const aiml_engine_1 = require("./src/services/aiml-engine");
const aiml_service_1 = require("./src/services/aiml-service");
...
async function runIntegrationTest() {
    ...
    try {
        ...
        const engine = new aiml_engine_1.AimlEngine();
        const testAiml = `
    ...
    `;
        const priorityEngine = new aiml_engine_1.AimlEngine();
        ...
        console.log('\nTest 3: Sample Patterns File');
        const sampleEngine = new aiml_engine_1.AimlEngine();
        const samplePath = path_1.default.join(__dirname, 'src/data/sample-patterns.xml');
        const sampleContent = await promises_1.default.readFile(samplePath, 'utf-8');
        ...
        const service = new aiml_service_1.AimlService();
        // Mock the ConfigMap loading by loading sample patterns directly
        const serviceEngine = service.engine;
